      ...
      <div class="nav-bg">
        <nav class="navSize">
          ...
          <div class="itemCenter">
            ...
            <div style="display:flex;">
                ...
                <router-link to="/addedit" class="navbar-item itemSpacing font-in-nav" style="color:blue;" v-if="user && user.user_role == 'admin' ">
                  Add / Edit
                </router-link>
                <!--Cart-->
        ...
        <div id="showmenu">
          <div class="cilckHamburger">
            ...
            <router-link to="/addedit" class="navbar-item borderItem font-in-nav" style="color:blue;" v-if="user && user.user_role == 'admin' ">
              Add / Edit
            </router-link>
