    ...
    <div class="nav-bg">
      <nav class="navSize">
        <div class="itemLeft">
          ...
          <div @click="getCartItem" class="nav-cart-icon">
            <!--Cart-->
            <svg
              v-show="checkRoute($route.fullPath)"
        ...
        <div class="itemCenter">
          ...
          <div style="display: flex">
            ...
            <div @click="getCartItem" v-show="checkRoute($route.fullPath)">
              <svg
                @click="(showEditItem = true), getCartItem"
        ...
        <div class="itemRight">
          ...
          <div style="display: flex" v-if="user">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              style="cursor: pointer; width: 2em; height: 2em; margin: auto"
              class="itemSpacing"
              viewBox="0 0 512 512"
            >
              <path
      ...
      <div id="showmenu">
        <div class="cilckHamburger">
          ...
          <router-link
            to="/manage"
            class="navbar-item borderItem font-in-nav"
            style="color: blue"
            v-if="user && user.user_role == 'admin'"
          >
            Manage
          ...
          <div
            style="display: flex; margin-left: 1em; height: 65px"
            v-if="user"
          >
            <router-link
              to="/profile"
          ...
          >
            ...
            <div class="modal-cart-item-info">
              ...
              <p class="modal-cart-item-price-c">
                ฿{{ formatCurrency(obj.price * obj.quantity) }}
              </p>
              <p style="font-size: 12px; color: gray" class="mt-1">
                {{ obj.size }} US {{ obj.type }}
              </p>
              <div style="display: flex">
                <p
                  style="
...
export default {
  ...
  methods: {
    ...
    getRedeem() {
      axios
        .get("http://localhost:3000/user/redeem/")
        .then((response) => {
